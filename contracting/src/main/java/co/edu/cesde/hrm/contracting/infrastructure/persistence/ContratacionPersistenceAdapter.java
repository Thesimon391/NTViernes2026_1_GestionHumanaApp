...
public class ContratacionPersistenceAdapter implements ContratacionPersistencePort {
    ...
    @Override
    public Optional<Contrato> findContratoVigenteByEmpleadoId(Long empleadoId) {
        return contratoJpaRepo.findFirstByEmpleado_IdAndEstadoOrderByFechaInicioDescIdDesc(empleadoId, EstadoContrato.VIGENTE)
                .map(this::toDomainContrato);
    }

    @Override
    public Optional<Contrato> findUltimoContratoByEmpleadoId(Long empleadoId) {
        return contratoJpaRepo.findFirstByEmpleado_IdOrderByFechaInicioDescIdDesc(empleadoId)
                .map(this::toDomainContrato);
    }
